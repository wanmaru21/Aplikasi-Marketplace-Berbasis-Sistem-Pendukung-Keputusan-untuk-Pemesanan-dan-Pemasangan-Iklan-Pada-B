...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{route ('vendor.storeBillboard') }}" 
                method="POST" enctype="multipart/form-data">@csrf
                <div class="form-group">
                    <label for="nama_bill">Nama Billboard</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="latbox" value="lat">
                </div>

                <div class="form-group">
                    <label for="long">Longitude</label>
                    <input type="text" class="form-control" name="lngbox" value="lng">
                </div>
