...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{route ('vendor.updatePenyewaan') }}" method="POST" enctype="multipart/form-data">@csrf
                ...
                <div class="form-group">
                    <label for="tgl_awal_sewa">Tanggal Awal Sewa</label>
                    <input type="date" name="tgl_awal_sewa">
                </div>  

                <div class="form-group">
                    <label for="tgl_awal_sewa">Tanggal Akhir Sewa</label>
                    <input type="date" name="tgl_akhir_sewa">
                </div>  
